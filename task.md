...
- [x] **Subscription System**
    ...
    - [x] Feature Gating (Restrict advanced backgrounds/limits - Editor.tsx)
    - [ ] Feature Gating (Restrict custom branding in WalletBuilder.tsx)
...
- [ ] **Phase 13: Admin Super Dashboard** <!-- id: 160 -->
    ...
    - [x] Fix: Blank screen crash in Card Editor (undefined socialLinks.map) <!-- id: 389 -->
        - [x] CardBuilder: Robust data loading with initialCardData fallback <!-- id: 390 -->
        - [x] Editor: Defensive rendering with array null-safety <!-- id: 391 -->
    - [x] Add Pricing Section to Home Page <!-- id: 392 -->
        - [x] Refactor Pricing logic into reusable PricingCards component <!-- id: 393 -->
        - [x] Integrate PricingCards into LandingPage without buttons <!-- id: 394 -->
